...
function uploadImg(){
    ...
    uploadFiles($dir, function($file) use($dir){
        ...
        executeQuery("INSERT INTO product (name, image, short_description, description, price, category_id, path) VALUES ('$name', '$filename', '$short_description', '$description', '$price', '$category_id', '$path')");
  });
}
